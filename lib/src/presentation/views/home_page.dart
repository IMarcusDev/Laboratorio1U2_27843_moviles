...
import 'package:laboratorio1u2_27843_app/src/presentation/views/edit_recipe_page.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text("Editar Receta", style: TextStyle(fontWeight: FontWeight.bold)),
              onTap: () {
                Navigator.pop(ctx);
                Navigator.push(
                  context,
            ...
            ListTile(
              ...
              title: const Text("Eliminar Receta", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.red)),
              onTap: () {
                Navigator.pop(ctx);
